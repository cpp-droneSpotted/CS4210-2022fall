        ...
        for a in range(2):  # iterates over the algorithms
            ...
            if a == 0:
                if accuracy > highest_accuracy_Perceptron:
                    ...
                    print("Highest Perceptron accuracy so far: {}, Parameters: learning rate={}, shuffle={}".format(highest_accuracy_Perceptron, w, b))
            else:
                if accuracy > highest_accuracy_MLP:
                    highest_accuracy_MLP = accuracy
                    print("Highest MLP accuracy so far: {}, Parameters: learning rate={}, shuffle={}".format(highest_accuracy_MLP, w, b))
